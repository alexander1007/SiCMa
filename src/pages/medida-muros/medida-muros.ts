...
export class MedidaMurosPage {
  ...
  onKeyUp() {
    this.variable1 = this.variable1.replace(" ", "");
    this.variable1 = this.variable1.replace("-", "");
    this.variable1 = this.variable1.replace("/", "");
    this.variable1 = this.variable1.replace("+", "");
    this.variable1 = this.variable1.replace("}", "");
    ...
    this.variable1 = this.variable1.replace("=", "");
    this.variable1 = this.variable1.replace("*", "");
    this.variable1 = this.variable1.replace("_", "");
    this.variable1 = this.variable1.replace("{", "");
    this.variable1 = this.variable1.replace("[", "");
  ...
  onKeyUp1() {
    ...
    this.variable2 = this.variable2.replace("=", "");
    this.variable2 = this.variable2.replace("*", "");
    this.variable2 = this.variable2.replace("_", "");
  }

  onKeyUp2() {
    this.variable3 = this.variable3.replace(" ", "");
    this.variable3 = this.variable3.replace("-", "");
    this.variable3 = this.variable3.replace("/", "");
    this.variable3 = this.variable3.replace("+", "");
    // this.variable1 = this.variable1.replace(".", "");
  ...
  calcularMateriales() {
    ...
    this.mtcuadrados = 0;
    this.valorTotalC = 0;
    var temporal1 = parseInt(this.variable1);
    var temporal2 = parseInt(this.variable2);
    var temporal3 = parseInt(this.variable3);
    ...
    if ((parseInt(this.variable1) == 0) || (parseInt(this.variable2) == 0)) {
      const alert = this.alertCtrl.create({
        title: 'SiCMa',
        subTitle: 'El valor del ' + this.p_variable1 + ', el valor ingresado debe ser mayor que cero. ',
        buttons: ['OK']
      });
      alert.present();
      return;
